...
It is a sibling of the superseded-worker race in [`settled-state-lands-on-successor`](./settled-state-lands-on-successor.md): the same one-round-trip window, exercised by a thread in the same process rather than by an earlier attempt.
